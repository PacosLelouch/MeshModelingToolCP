...
public:
	...
	// -------------------------------------------------------------------------
	void setMatN(const std::string &name, const std::vector<glm::mat4>& mats, int n) const
	{
		glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), n, GL_FALSE, &(*mats.data())[0][0]);
	}

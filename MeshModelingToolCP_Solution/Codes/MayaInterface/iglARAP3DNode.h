...
#include "Operations/iglARAP3DOperation.h"

struct iglARAP3DCache
{
    int numIter = -1;
...
class MiglARAP3DNode : public MGeometryOptimizerNode
{
public:
...
public:
    ...
    std::shared_ptr<AAShapeUp::iglARAP3DOperation> m_operationShPtr; 

    iglARAP3DCache m_cache;

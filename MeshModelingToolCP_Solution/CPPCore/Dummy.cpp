...
void DummyTest()
{
    ...
    ConstraintBase<3, IdentityProjectionOperator<3>, IdentityWeightTripleGenerator<3>, IdentityTransformer<3> > constraint3(ids, 1.0f);
    ...
    GeometrySolver<3, nullptr_t, nullptr_t> geometrySolver;
